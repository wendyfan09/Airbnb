...
public class SliddingPuzzle {
    ...
    public class Solution {
        //four direction: Down, Right, Up, Left
        ...
        public Solution(int[][] matrix) {
            ...
            //construct correct string sequence
            ...
            while (!items.isEmpty()) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    for (int k = 0; k < dirs.length; k++) {
                        ...
                        //use current String geneate matrix
                        ...
                        //if this step already used, then passed and continue
                        if (visited.contains(newMatrixString)) {
                            continue;
                        }

                        //add current step to queue/matrix/visited set
    ...
    public static class UnitTest {
        ...
        public void test1() {
            ...
            Solution sol = new SliddingPuzzle().new Solution(matrix);
